...
import TypesetRule from './atrules/apply/TypesetRule.js'
import DisplayRule from './atrules/apply/DisplayRule.js'
...
// import MediaQueryStore from './data/stores/MediaQueryStore.js'
...
export default class Stylesheet {
  ...
  // #mediaQueries = new MediaQueryStore()
  ...
  constructor (filepath, imported = false) {
    ...
    this.#root.walkAtRules(atrule => {
      switch (atrule.name) {
        ...
        // case 'media': return this.#mediaQueries.add(atrule)
      }
    })
  }
  ...
  // getMediaQuery (atrule) {
  //   return this.#mediaQueries.get(atrule)
  // }
  ...
  //       break
  //
  //     default: return cb(atrule.error(`\nInvalid at-rule "${atrule.type}"`))
  //   }
  //
  //   atrule.remove()
  //   cb()
