  ...
  reset ({ block, theme }) {
    return `
      ...
      *, *:before, *:after {
      ...
      ${CSSUtils.createRule(theme.headings.map(heading => heading.name).join(', '), theme.sharedHeadingStyles).toString()}
    `
  },
...
//   static core (components, theme, cb) {
//     let root = CSSUtils.createRoot([])
//
//     QueueUtils.run({
//       pad: {
...
//
//         {
//           name: 'Generating Component Resets',
//           callback: next => {
//             this.generateComponentResets(components, (err, result) => {
//               if (err) {
//                 return cb(err)
//               }
//
...
//         //   callback: next => {
//         //     this.resolveComponents(components, (err, result) => {
//         //       if (err) {
//         //         return cb(err)
//         //       }
//         //
