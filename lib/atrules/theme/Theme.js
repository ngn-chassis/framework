...
export default class Theme extends Class {
  ...
  get components () {
    return this.#source.components?.nodes.reduce((components, component) => {
      let states = []
      let nodes = component.nodes.filter(node => {
  ...
  get headings () {
    return this.#source.headings?.nodes.reduce((headings, heading) => {
  ...
  get properties () {
    return this.#source.properties?.nodes.reduce((properties, property) => {
