...
export default class Expression {
  ...
  #processSingleViewportComparison = (props, first) => {
    ...
    let dimensions = {
      min: NGN.coalesce(viewport[this.#dimension].min, ViewportUtils.getPreviousBound(viewport, this.#dimension, 'max')),
      max: NGN.coalesce(viewport[this.#dimension].max, ViewportUtils.getNextBound(viewport, this.#dimension, 'min'))
    }
