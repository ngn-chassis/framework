...
module.exports = class FileUtils {
	...
	static getImportFilepath (relative, from) {
		let filename = this.getFileName(relative)
		let absolute = path.join(path.dirname(from), this.getFilePath(relative), filename.startsWith('_') ? filename : `_${filename}`)
	...
	static getImportedFileContents (filepath, basePath) {
		let importPath = this.getImportFilepath(...arguments)
